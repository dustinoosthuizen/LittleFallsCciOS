...
#import "UIFontSecretFont.h"
#import "CommentCell.h"
#import "UIViewGradientMask.h"

#import <QuartzCore/QuartzCore.h>
#define HEADER_HEIGHT 240.0f
#define HEADER_INIT_FRAME CGRectMake(0, 0, self.view.frame.size.width, HEADER_HEIGHT)
#define TOOLBAR_INIT_FRAME CGRectMake (0, 292, 240, 22)

const CGFloat kBarHeight = 0.0f;
...
@interface MenuExpandingViewController () <UIScrollViewDelegate, UITableViewDataSource, UITableViewDelegate>

@end

@implementation MenuExpandingViewController {
...
- (void)viewDidLoad
{
    ...
    imageView.image = [UIImage imageNamed:@"image1_320x210.png"];
...
//    [_commentsViewContainer addGradientMaskWithStartPoint:CGPointMake(0.5, 0.0) endPoint:CGPointMake(0.5, 0.03)];
    ...
    comments = [@[@"Oh my god! Me too! iwejoijwedpoijpwedpweodjpojwdpeodjwpeodj[wdc[sokcds[fovie[rovnierw v[eowivn [ewoivn ew[voin ve[oijdf pvidsnfv opidsfubv odsifbv vodfisuv osdiufhv dsfoiuvh dfsoviu dfsov dsiofuv dosiuvh dosviuhsdv oidusv odsv odsv pdsiuvh dpviuhdsv idsufhv odsiuvh dsoviuhdsv piudshv pdsiuvh pdsivuh dsvpiuhdv pisudhv pdisuhv psdifuvh dspivuh dspviuhsdv piudshv pdsiufvh pdisfuvh sdpifuvh dspifvuh epiuvhdfpisuhv pdsfiuvh dfpsiuvh oidsgf voudysfv giusydg dsouyg dsofugy sdfougy dsfougy dsfo uygd uydg odsuyg oduyfg dosuyfg odsufyg odfsuyg dousfyg odsuyfg osduyfg odsufyg odsufyg ods ufgy dsou gydsofugy dosufgy dsou gydsouf gysdoufgy dsofu gydsofugy sdofugy dsfouyg dosufyg sdoufgy dfsou gysdofgy sdougy dsougy dosf gydsofu gydsfougy  dspviuhds pviuhsdf pviuhdsfpviu hdvpiudhsv piduhv psidufhv psdifuhv psdiufhv psdifuvh dfs", @"No way! I love secrets too!", @"I for some reason really like sharing my deepest darkest secrest to the entire world", @"More comments", @"Go Toronto Blue Jays!", @"I rather use Twitter", @"I don't get Secret", @"I don't have an iPhone", @"How are you using this then?"] mutableCopy];
